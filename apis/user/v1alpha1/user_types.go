...
type UserObservation struct {
	...
	// AdminRoleInAuth indicates if the user has admin role in auth mode
	AdminRoleInAuth *bool `json:"adminRoleInAuth,omitempty"`

	// OidcUserMeta contains OIDC user metadata if applicable
	// +kubebuilder:pruning:PreserveUnknownFields
	OidcUserMeta map[string]string `json:"oidcUserMeta,omitempty"`
}
...
// +kubebuilder:printcolumn:name="ADMIN",type="boolean",JSONPath=".spec.forProvider.sysAdminFlag"
