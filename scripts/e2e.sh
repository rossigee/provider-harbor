...
#
# Env knobs:
#   KIND_CLUSTER (harbor-e2e)  REGISTRY (ghcr.io/rossigee)  PROVIDER (provider-harbor)
#   VERSION (required: a published package tag, e.g. v0.17.0)
...
VERSION="${VERSION:?set VERSION to a published package tag, e.g. v0.17.0}"
